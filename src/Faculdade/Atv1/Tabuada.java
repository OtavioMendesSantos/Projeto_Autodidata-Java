package Faculdade.Atv1;// 7. Escreva um programa que solicite ao usuário um valor N, entre 1 e 10, e calcule a
...
public class Tabuada {
    public static void main(String[] args) {
        ...
        System.out.println("Faculdade.Atv1.Tabuada do " + numero + ":");
        for (int i = 0; i <= 10; i++) {
